...
Everything the pod-side installer can do: the feature list, the quick
start, the wizard, the model tiers, workflows, presets, the
pre-installed Docker image, backups, LoRAs, notifications, tmux, the
CLI and GPU support.
