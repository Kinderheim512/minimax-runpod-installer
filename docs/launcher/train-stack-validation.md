...
| 1 | `minimax-launcher start --stack train` reaches the desktop | ⬜ needs a pod |
...
3. Store the template id: `minimax-launcher credentials set` (field *RunPod Train template
